...
const Login = () => {
  const handleSignIn = (e) => {
    ...
    /*  signin(email, password)
      .then((res) => {
        ...
        Swal.fire("Great!", "Successfully Logged In", "success");
  ...
  return (
    <div>
      ...
      >
        <Typography variant="T_Medium_H6">Login </Typography>
      </button>

      {/* Modal Body  */}
      <dialog id="loginModal" className="modal bg-dark/40">
          ...
          <div className=" bg-dark  ">
            ...
            <div className="border-[1px] border-dark/20 rounded-lg p-8">
              <Typography variant="T_Bold_H4">
                <span className="flex justify-center text-light">Sign In</span>
              </Typography>
              ...
              >
                ...
                <div className="inline-flex items-center">
                  ...
                  >
                    <input
                      type="checkbox"
                      className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-primary checked:bg-cyan-500 checked:before:bg-cyan-500 hover:before:opacity-10"
                      id="checkbox"
                      required
                    />
